<template>
  <div class="min-h-screen flex flex-col md:flex-row font-manrope bg-gray-100">
    <aside class="w-full md:w-[200px] mr-0 md:mr-6 border-r border-gray-200 bg-white p-6">
      ...
      <p class="text-gray-400 text-xs pt-3">Dashboard example</p>
    </aside>

    <main class="flex-1">
      <header class="bg-white border-b border-t border-gray-200 p-4 flex justify-between items-center">
        <p>General</p>
        <p class="text-sm">Hello, Aya Nakamura</p>
      </header>
